      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 mb-12">
          ...
          <div className="md:col-span-4">
            ...
            <p className="text-gray-500 dark:text-gray-400 mb-4 text-sm">Join thousands of users receiving weekly opportunities.</p>
            <form onSubmit={handleSubscribe} className="flex gap-2">
              <div className="relative flex-grow">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 border border-gray-200 dark:border-gray-700 rounded-xl bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-primary-500"
                  required
                />
              </div>
              <button 
                type="submit" 
                disabled={subscribed}
                className={`px-6 py-2.5 rounded-xl font-medium transition flex items-center gap-2 whitespace-nowrap ${subscribed ? 'bg-green-500 text-white' : 'bg-primary-600 hover:bg-primary-700 text-white'}`}
              >
                {subscribed ? <><FiCheck /> Joined</> : 'Join'}
              </button>
            </form>
          </div>
        </div>
        ...
        <div className="pt-8 border-t border-gray-100 dark:border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {new Date().getFullYear()} JoblifyHQ. All rights reserved.
          </p>
