...
export const fetchJobs = async () => {
  ...
  return [
    ...
    { id: '4', title: 'DevOps Engineer', company: 'CloudSync', location: 'Berlin, DE', type: 'Full-time', category: 'Engineering', deadline: '2026-06-20', description: 'Manage CI/CD pipelines & AWS infrastructure.', salary: '$110k-$140k', posted: '5d ago' },
  ];
};
...
export const fetchScholarships = async () => {
  ...
  return [
    ...
    { id: 's3', title: 'Tech Innovators Scholarship', org: 'SiliconValley Fund', country: 'Remote/Online', type: 'Full Funding', deadline: '2026-09-01', description: 'For coding bootcamp & CS degree students.', benefits: 'Full tuition + laptop', posted: '2d ago' },
  ];
};
...
export const fetchBlogs = async () => {
  ...
  return [
    ...
    { id: 'b3', title: 'Scholarship Applications: Common Mistakes to Avoid', excerpt: 'Learn how to write compelling personal statements and organize your documents effectively.', author: 'Amina Johnson', date: 'Apr 25, 2026', category: 'Education', image: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=600&q=80' },
  ];
};
