      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          ...
          <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm">
            {isPremium ? (
              ...
              <button onClick={() => navigate('/premium')} className="w-full h-full flex flex-col items-start justify-center text-left">
        ...
        {!isPremium && (
          <div className="mb-8 bg-gradient-to-r from-primary-600 to-purple-600 rounded-2xl p-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-white">
            ...
            <button onClick={() => navigate('/premium')} className="bg-white text-primary-700 font-bold px-5 py-2.5 rounded-xl text-sm hover:bg-primary-50 transition whitespace-nowrap self-start sm:self-center">
              See Plans →
            </button>
          </div>
        )}
            ...
            <section>
              ...
              {savedJobs.length === 0 ? (
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
                  ...
                  <Link to="/jobs" className="inline-block bg-primary-600 hover:bg-primary-700 text-white font-medium px-6 py-2.5 rounded-lg transition">Browse Jobs</Link>
                </div>
              ) : (
                <div className="space-y-3">
                  {savedJobs.slice(0, 3).map(job => {
                    ...
                    return (
                      <Link key={job.id} to={`/jobs/${data.id || job.jobId}`}
            ...
            <section>
              ...
              {applications.length === 0 ? (
                <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-8 text-center">
                  ...
                  <Link to="/jobs" className="inline-block bg-primary-600 hover:bg-primary-700 text-white font-medium px-6 py-2.5 rounded-lg transition">Find Opportunities</Link>
                </div>
              ) : (
              ...
              <section>
                ...
                <div className="space-y-3">
                  {savedScholarships.slice(0, 2).map(sch => {
                    ...
                    return (
                      <Link key={sch.id} to={`/scholarships/${data.id || sch.scholarshipId}`}
                        className="block bg-white dark:bg-gray-800 p-5 rounded-xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-md hover:border-primary-200 dark:hover:border-primary-700 transition">
            ...
            {isPremium ? (
              ...
              <>
                <div className="bg-gradient-to-br from-primary-600 to-purple-700 rounded-2xl p-6 text-white text-center">
                  ...
                  <button onClick={() => navigate('/premium')} className="bg-white text-primary-700 font-bold px-8 py-3 rounded-xl hover:bg-primary-50 transition">View Premium Plans →</button>
                </div>
                <div>
