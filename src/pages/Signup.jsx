...
export default function Signup() {
  ...
  return (
    <div className="max-w-md mx-auto mt-10 bg-white p-8 rounded-xl border border-gray-200 shadow-sm">
      ...
      <p className="text-gray-600 mb-6">Join JoblifyHQ to save opportunities & track applications.</p>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <FormInput label="Full Name" value={form.name} onChange={(e) => setForm({...form, name: e.target.value})} error={errors.name} placeholder="John Doe" />
        ...
        <FormInput label="Confirm Password" type="password" value={form.confirmPassword} onChange={(e) => setForm({...form, confirmPassword: e.target.value})} error={errors.confirmPassword} placeholder="••••••••" />
